...
public class PreprocessingFunctions {
    ...
    public void preparePreprocess() throws Exception {
        ...
        if (System.getProperty(Strings.OS_NAME).toLowerCase().startsWith(Strings.WINDOWS)) {
            ...
            bw.newLine();
            bw.write("REM  Copyright (C) " + Calendar.getInstance().get(Calendar.YEAR) + " - " + Strings.SPAZIOIT_WWW);
            bw.newLine();
            bw.newLine();
            ...
            bw.newLine();
            bw.write("#  Copyright (C) " + Calendar.getInstance().get(Calendar.YEAR) + " - " + Strings.SPAZIOIT_WWW);
            bw.newLine();
            bw.newLine();
            bw.write("cd " + p.getBaseDirectory());
            bw.newLine();
    ...
    public void preProcess() throws Exception {
        ...
        if (System.getProperty(Strings.OS_NAME).toLowerCase().startsWith(Strings.WINDOWS)) {
            ...
            commandLine = Strings.BASH + p.getBaseDirectory() + "/" + p.getProjectName() + "_prepro.sh";
        }
        if (SAFacilitator.isGuiEnabled()) {
            MainFrame.getStopRunningMenuItem().setText("Stop Preprocessing Execution");
    ...
    public void showCompilerDefines() throws Exception {
        ...
        if (System.getProperty(Strings.OS_NAME).toLowerCase().startsWith(Strings.WINDOWS)) {
            ...
            bw.flush();
            bw.close();
            commandLine = Strings.BASH + fileName;
        }
        if (SAFacilitator.isGuiEnabled()) {
            MainFrame.getStopRunningMenuItem().setText("Stop Show Compiler Defines");
            MainFrame.getStopRunningMenuItem().setDisable(false);
        }
