...
public class AnalyzersFunctions {
    ...
    void preparePcLint() throws Exception {
        ...
        if (System.getProperty(Strings.OS_NAME).toLowerCase().startsWith(Strings.WINDOWS)) {
            ...
            bw.newLine();
            bw.write(GENERATED_BY_WIN + Calendar.getInstance().getTime());
            bw.newLine();
            bw.write(COPYRIGHT_WIN + Calendar.getInstance().get(Calendar.YEAR) + " - " + Strings.SPAZIOIT_WWW);
            bw.newLine();
            bw.newLine();
            ...
            bw.newLine();
            bw.write(GENERATED_BY_UNX + Calendar.getInstance().getTime());
            bw.newLine();
            bw.write(COPYRIGHT_UNX + Calendar.getInstance().get(Calendar.YEAR) + " - " + Strings.SPAZIOIT_WWW);
            bw.newLine();
            bw.newLine();
            bw.write("cd " + p.getBaseDirectory());
            bw.newLine();
